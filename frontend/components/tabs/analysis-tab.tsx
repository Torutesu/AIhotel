...
/**
 * 各分析セクション共通のprops。
 * targetPeriod が渡されない場合はセクション内部のstateで動作する（単体でも自己完結）。
 */
...
/** 対象期間に応じたモックデータ（チャネル/部屋タイプ/予約期間/セグメント）を生成する純粋関数 */
function buildPeriodData(targetPeriod: string) {
...
// ============================================================================
// 競合価格分析（実データ: api.competitorAnalysis — F-ANA-02）
// ============================================================================
